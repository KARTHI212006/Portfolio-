...
export const personalInfo = {
  ...
  nickname: "Karthi",
  headline: "Java Developer | Full Stack Web Developer | Prompt Engineer",
  intro: "I am a passionate Fourth-Year Computer Science and Engineering student with a strong interest in Java Development, Full Stack Web Development, Prompt Engineering, and Artificial Intelligence. I enjoy solving real-world problems through software and continuously learning new technologies.",
  about: "My goal is to build impactful applications that combine clean code, creativity, and innovation. I am driven by a passion for Artificial Intelligence, Java programming, and modern web development. My journey combines hands-on IoT internship experience with full stack web projects and real-world Java applications.",
  objective: "To become a skilled software engineer who contributes to innovative, impactful applications — combining Java expertise, full stack development, and AI integration to solve real-world challenges.",
  location: "Salem, Tamil Nadu, India",
  email: "karthikeyankarthikeyan1710@gmail.com",
  phone: "+91 8838726100",
  github: "https://github.com/KARTHI212006",
  linkedin: "https://www.linkedin.com/in/karthi-keyan-467313382/",
...
export const education = [
  {
    ...
    color: "#8B5CF6",
    highlights: [
      "CGPA: 8.1 / 10 — Consistent Academic Performance",
      "Focused on Core Computer Science, Java Development & Web Technologies",
      "Active in technical symposiums, IoT labs & hands-on project work",
    ],
  },
  {
    ...
    color: "#06B6D4",
    highlights: [
      "Foundational training in Computer Applications & Mathematics",
      "Developed early passion for programming and software design",
    ],
  },
];
